...
# Adapted from plot_detections in bliss.plotting
def my_plot_detections(
    index, images, true_tile_cat, est_tile_cat, margin_px, ticks=None, figsize=None
):
    """Plots an image of true and estimated sources."""
    nrows = 1
    img_ids = torch.tensor([index], device=images.device)
