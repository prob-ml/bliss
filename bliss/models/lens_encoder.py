...
from bliss.models.detection_encoder import EncoderCNN, make_enc_final
...
class LensEncoder(pl.LightningModule):
    ...
    def sample(self, image_ptiles: Tensor, tile_locs: Tensor):
        ...
        for param_idx in range(pure_lens_dim):
            ...
            # lens_params[...,2 * param_idx + self.latent_dim_split] = dist_mean
            # lens_params[...,2 * param_idx + 1 + self.latent_dim_split] = dist_sd
