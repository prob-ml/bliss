...
from bliss.encoders.ae import CenteredGalaxyEncoder, OneCenteredGalaxyAE
...
class GalaxyEncoder(pl.LightningModule):
    def __init__(
        ...
        self.bp = self.image_decoder.bp
        self.ptile_slen = self.tile_slen + 2 * self.bp
    ...
    def _make_plots(self, batch, n_samples=5):
        ...
        for i, idx in enumerate(worst_indices):
            ...
            plot_plocs(true_ax, bp, slen, plocs, probs, cmap="cool")
            plot_image(fig, recon_ax, image, vrange=vrange, colorbar=True)
            plot_plocs(recon_ax, bp, slen, plocs, probs, cmap="cool")
