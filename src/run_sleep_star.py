...
def get_dataset(n_images, psf_og, data_params, background,
                transpose_psf=False, add_noise=True, draw_poisson=True):
    star_dataset = \
        simulated_datasets_lib.StarsDataset.load_dataset_from_params(n_images, data_params, psf_og,
                                                                     background,
...
def train(star_encoder, dataset, optimizer):
    ...
    sleep_lib.run_sleep(star_encoder, dataset, optimizer, n_epochs,
