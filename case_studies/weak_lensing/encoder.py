...
from case_studies.weak_lensing.convnet import MassMapNet, ScalarShearNet
from case_studies.weak_lensing.variational_dist import VariationalDist


class MassMapEncoder(pl.LightningModule):
    def __init__(
        self,
        n_bands: int,
        res_init: int,
...
class ScalarShearEncoder(pl.LightningModule):
    def __init__(
        self,
        n_bands: int,
        image_normalizers: list,
