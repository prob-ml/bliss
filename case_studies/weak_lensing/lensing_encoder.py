...
class WeakLensingEncoder(Encoder):
    ...
    def on_train_epoch_end(self):
        ...
        print(f"Average train loss for epoch {self.current_epoch}: {avg_epoch_train_loss}")  # noqa: WPS421
    ...
    def on_validation_epoch_end(self):
        ...
        self.current_epoch_val_loss = 0.0
        self.current_epoch_val_batches = 0
        print(f"Average val loss for epoch {self.current_epoch}: {avg_epoch_val_loss}")  # noqa: WPS421
