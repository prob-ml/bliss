...
Usage:
    python run_anacal.py --input-dir /path/to/images --output-file results.pt
    python run_anacal.py --input-dir /path/to/images --output-file results.pt --n-workers 28
"""
...
def anacal_multiband_combined(
    ...
    Returns
    -------
    e1_sum, e1g1_sum, e2_sum, e2g2_sum, num_detections, fpfs_output
    """
...
def main():
    parser = argparse.ArgumentParser(description="Run AnaCal processing on generated images")
    parser.add_argument(
        "--input-dir", type=str, required=True, help="Directory containing dataset_*.pt files"
    )
    parser.add_argument(
        "--output-file", type=str, required=True, help="Path for output results file"
    )
    parser.add_argument(
        "--config", type=str, default=None, help="Path to YAML config file (optional)"
    )
    parser.add_argument("--start-idx", type=int, default=0, help="Start processing from this index")
    parser.add_argument("--end-idx", type=int, default=None, help="End processing at this index")
    parser.add_argument(
        "--checkpoint-interval",
        type=int,
        default=50,
        help="Save checkpoint every N images (0 to disable)",
    )
    parser.add_argument(
        "--n-workers",
        type=int,
