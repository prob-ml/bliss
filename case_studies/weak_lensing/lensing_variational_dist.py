...
from bliss.encoder.unconstrained_dists import UnconstrainedNormal, UnconstrainedTDBN
...
class LensingVariationalDistSpec(VariationalDistSpec):
    def __init__(
        ...
        **kwargs,
        ...
        self.factor_specs["shear"] = UnconstrainedTDBN()
...
class LensingVariationalDist(VariationalDist):
    ...
    def compute_nll(self, true_tile_cat: LensingTileCatalog):
        non_lensing_loss = super().compute_nll(true_tile_cat)
        lensing_loss = 1.0

        return non_lensing_loss + lensing_loss
