...
from bliss.encoder.unconstrained_dists import UnconstrainedLogNormal, UnconstrainedTDBN
...
class LensingVariationalDistSpec(VariationalDistSpec):
    def __init__(
        ...
        **kwargs,
        ...
        self.factor_specs["shear"] = UnconstrainedTDBN(a=-1, b=1)
...
class LensingVariationalDist(VariationalDist):
    ...
    def compute_nll(self, true_tile_cat: TileCatalog):
        sources_loss = super().compute_nll(true_tile_cat)
