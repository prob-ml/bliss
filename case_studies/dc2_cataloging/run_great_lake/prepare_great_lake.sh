...
rsync -av --info=progress2 \
 /nfs/turbo/lsa-regier/scratch/pduan/dc2_cached_data.tar \
 /scratch/regier_root/regier0/pduan/dc2local/
pv /scratch/regier_root/regier0/pduan/dc2local/dc2_cached_data.tar | tar -xf - -C /scratch/regier_root/regier0/pduan/dc2local/
