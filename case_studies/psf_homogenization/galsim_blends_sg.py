...
from bliss.datasets.galsim_galaxies import GalsimBlendsSG
from bliss.models.galsim_decoder import FullCatelogDecoderSG, UniformGalsimPrior
...
class GalsimBlendsSGwithPSF(GalsimBlendsSG):
    def __init__(
        self,
