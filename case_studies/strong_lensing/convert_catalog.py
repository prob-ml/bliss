...
col_names = ['IDENT', 'RA', 'DEC', 'MAG', 'BAND', 'WEIGHT', 'GAL_FILENAME', 'PSF_FILENAME', 'GAL_HDU', 
             'PSF_HDU', 'PIXEL_SCALE', 'NOISE_MEAN', 'NOISE_VARIANCE', 'NOISE_FILENAME', 'stamp_flux', 
             'LENSED', 'X', 'Y', 'N1', 'HALF_RAD', 'FLUX1', 'N2', 'SCALE_RAD', 'FLUX2', 'Q', 'BETA', 
             'THETA', 'X_LENSE', 'Y_LENSE', 'E1', 'E2']

col_dtypes = ['i4', 'f8', 'f8', 'f8', 'S5', 'f8', 'S32', 'S36', 'i4', 
              'i4', 'f8', 'f8', 'f8', 'S36', 'f8', 
              'S5', 'i4', 'i4', 'f8', 'f8', 'f8', 'f8', 'f8', 'f8', 'f8', 'i4',
              'f8', 'f8', 'f8', 'f8', 'f8']
...
with open('data/catalog.txt', 'r') as file:
    for line in file:
        ...
        if values[15] == 'True':
            row = (values[0], values[1], values[2], values[3], values[4], values[5], values[6], values[7], values[8], 
