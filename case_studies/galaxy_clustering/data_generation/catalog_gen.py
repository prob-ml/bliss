...
CATALOG_PATH = os.path.join(ENVIRONMENT_PATH, "data_generation/catalogs")
PADDED_CATALOG_PATH = os.path.join(ENVIRONMENT_PATH, "data_generation/padded_catalogs")
...
for i, catalog in enumerate(catalogs):
    file_name = f"data_generation/catalogs/{FILE_PREFIX}_{i:03}.dat"
    ...
    padded_file_name = f"data_generation/padded_catalogs/{FILE_PREFIX}_padded_{i:03}.dat"
