...
def create_rail_artifacts(rail_cfg: DictConfig):
    ...
    """
    logging.info("Creating RAIL artifacts at %s", rail_cfg.paths.output_dir)
    ...
    lsst_catalog_subset = lsst_catalog_gcr.get_quantities(rail_cfg.pipeline.quantities)
...
def create_bliss_artifacts(bliss_cfg: DictConfig):
    ...
    """
    logging.info("Creating BLISS artifacts at %s", bliss_cfg.paths.processed_output_dir)
