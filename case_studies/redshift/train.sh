...
export TRAIN_PATH="${HOME}/bliss/data/redshift/dc2/desc_dc2_run2.2i_dr6_truth_nona_train_set.pkl"
export VAL_PATH="${HOME}/bliss/data/redshift/dc2/desc_dc2_run2.2i_dr6_truth_nona_val_set.pkl"
echo "start training!"
