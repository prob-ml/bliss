...
@hydra.main(config_path=".", config_name="mdn_eval")
def main(cfg: DictConfig):
    # with initialize(config_path=".", job_name="bspline_eval"):
    #     cfg = compose(config_name="bspline_eval")
    k = 0
    ...
    # load bliss trained model - continuous version
    bliss_output_path = output_dir / "mdn_mode_metrics_{}thbest_new_bins.pkl".format(k)
