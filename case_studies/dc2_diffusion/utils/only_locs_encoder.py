...
from case_studies.dc2_diffusion.utils.only_locs_diffusion import DiffusionModel
from case_studies.dc2_diffusion.utils.detection_net import SimpleDetectionNet


class OnlyLocsDiffusionEncoder(pl.LightningModule):
    def __init__(
        self,
        survey_bands: list,
        tile_slen: int,
    ...
    def initialize_networks(self):
        ...
        self.detection_net = SimpleDetectionNet(
            xt_in_ch=self.catalog_parser.n_params_per_source - 1, # minux 1 to exclude n_sources
            xt_out_ch=16,
            extracted_feats_ch=num_features,
            final_out_ch=self.catalog_parser.n_params_per_source,
        )
        self.detection_diffusion = DiffusionModel(
            ...
            target_size=(
                ...
                self.catalog_parser.n_params_per_source - 1,
            ),
