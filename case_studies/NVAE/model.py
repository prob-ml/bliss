...
from utils import get_arch_cells, get_stride_for_cell_type, get_input_size, groups_per_scale
...
class AutoEncoder(nn.Module):
    ...
    def decoder_output(self, logits):
        if self.dataset == 'mnist':
            ...
            return Normal(logits, log_sigma=logits)
            # raise NotImplementedError
