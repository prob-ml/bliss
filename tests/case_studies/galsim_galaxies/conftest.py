...
def get_galsim_galaxies_cfg(overrides):
    ...
    with initialize(config_path="../../../case_studies/galsim_galaxies/config", version_base=None):
...
class SingleGalsimGalaxiesSetup(ModelSetup):
    def get_cfg(self, overrides):
        return get_galsim_galaxies_cfg(overrides)


@pytest.fixture(scope="session")
def galsim_galaxies_setup(devices):
    return SingleGalsimGalaxiesSetup(devices)


@pytest.fixture(scope="session")
def get_galsim_galaxies_config():
    return get_galsim_galaxies_cfg
